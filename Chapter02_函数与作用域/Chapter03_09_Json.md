...
- _JSON_ (_JavaScript Object Notation_) ist ähnlich zur JavaScript-Schreibweise für Felder und Objekte
- Ausnahmen und Abweichungen
    - Alle Eigenschaftsnamen müssen in Anführungszeichen geschrieben werden
...
let zeichenkette=JSON.stringify({name: "x", born: 1980});

JSON.parse(zeichenkette).born;
```
