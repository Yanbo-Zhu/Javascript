...
# 6 引入方式: die Attribute defer und async
...
### 6.1.1 将 js script 放入 head 中出现的问题
...
### 6.1.2 将 js script 放入 html 末端 不会出现问题
...
### 6.2.1 Script ohne async / defer laden 会出现的问题
...
### 6.2.2 Script asynchron laden的优势
...
### 6.2.3 Laden mit defer verzögern的优势
...
### 6.2.4 DOMContentLoaded mit defer / async
