...
### 1.3.1 export / 暴露数据语法汇总  
（1）统一暴露  
![在这里插入图片描述](https://img-blog.csdnimg.cn/301c48bae2fb4e92ba02c6a044fcb1f8.png)  
（2）默认暴露（default）  
![在这里插入图片描述](https://img-blog.csdnimg.cn/88fc3a9e240247c299680a9bded54c1c.png)  
（3）分别暴露  
![在这里插入图片描述](https://img-blog.csdnimg.cn/edb5fee3db714c68a14181bdb5604dd4.png)


### 1.3.2 import/引入模块数据语法汇总  
（1）通用的导入方式  
![在这里插入图片描述](https://img-blog.csdnimg.cn/0527ab5e8c07441eb30b8a74967bc818.png)  
（2）解构赋值形式  
![在这里插入图片描述](https://img-blog.csdnimg.cn/017b8a8ef196425bb36c0620632d32f0.png)  
（3）简便形式（只针对默认暴露）  
![在这里插入图片描述](https://img-blog.csdnimg.cn/a18a9b4f47084e66a31d0063d0cfb7f6.png)

### 1.3.3 export default 导出和对应的 import 导入
